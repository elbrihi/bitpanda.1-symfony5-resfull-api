...
ALTER TABLE user_details ADD CONSTRAINT FK_2A2B15808F6E66E0 FOREIGN KEY (citizenship_country_id) REFERENCES countries (id);
ALTER TABLE user_details ADD CONSTRAINT FK_2A2B1580A76ED395 FOREIGN KEY (user_id) REFERENCES users (id);
